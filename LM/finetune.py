...
model = rnn.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.dropouth, args.dropouti, args.dropoute, args.wdrop, args.tied)
if args.cuda:
    model.cuda()
...
def train():
    ...
    while i < train_data.size(0) - 1 - 1:
        ...
        output, hidden, rnn_hs, dropped_rnn_hs = rnn(data, hidden, return_h=True)
